...
class TimeEntryQuery < Query
  ...
  self.available_columns = [
    ...
    QueryAssociationColumn.new(:issue, :fixed_version, :caption => :field_fixed_version, :sortable => Version.fields_for_order_statement, :groupable => "#{Issue.table_name}.fixed_version_id"),
  ...
  def initialize(attributes=nil, *args)
    super attributes
    self.filters ||= { 'spent_on' => {:operator => "m", :values => ['']} }
  end
