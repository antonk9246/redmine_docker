...
class QueryColumn
  ...
  def value(object)
    if time_entry_issue_nil?(object)
      nil
    elsif name == :"issue.fixed_version"
      object.issue.fixed_version
    else
      object.send name
    end
  end

  def time_entry_issue_nil?(object)
    return object.issue.nil? if object.is_a? TimeEntry
