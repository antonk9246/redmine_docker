...
class PeopleController < ApplicationController
  ...
  def index
    ...
    if @query.valid?
      ...
      @filter_tags = @query.filters['people_tags'] && @query.filters['people_tags'][:values].select(&:present?)
  ...
  def bulk_update
    ...
    @people.each do |person|
      ...
      unless person.update(parse_params_for_bulk_people_attributes(params.respond_to?(:to_unsafe_hash) ? params.to_unsafe_hash.symbolize_keys : params))
