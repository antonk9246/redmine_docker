...
class PeopleControllerTest < ActionController::TestCase
  ...
  def test_get_index_with_tag
    ...
    compatible_request :get, :index, :f => ['people_tags'], :op => { 'people_tags' => "=" }, :v => { 'people_tags' => ['Tag1'] }
  ...
  def test_get_vcf
    ...
    @person.information.update(phone: ', +7(123)- 45-67, 8(111)22-33-44, 1-234-456')
    ...
    @person.information.update(phone: phone_old_value)
  end
  ...
  def test_post_create_with_workday_length
    ...
    [
      ...
      assert_equal true, data[:workday_length] == person.information.workday_length
    end
  end
  ...
  def test_performance_tab_for_person_without_information
    ...
    assert_equal true, person.information.nil?
