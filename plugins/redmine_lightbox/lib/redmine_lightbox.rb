...
module RedmineLightbox
  ...
  class << self
    ...
    def lightbox_plugins_controllers
      ...
      controllers << 'EzfaqsController' if Redmine::Plugin.installed? 'ezfaq_plugin'
      ...
      if Redmine::Plugin.installed? 'redmine_itil'
        controllers << 'HelpdeskIssuesController'
        controllers << 'ContractsController'
        controllers << 'KeResolutionsController'
        controllers << 'ResolutionsController'
        controllers << 'ServiceLevelAgreementsController'
      end
      if Redmine::Plugin.installed? 'redmine_recruitment'
        controllers << 'JobApplicationsController'
        controllers << 'RecruitmentCompaniesController'
        controllers << 'UserApplicationsController'
        controllers << 'UserApplicantsController'
      end
      if Redmine::Plugin.installed? 'redmine_meta_roadmap'
        controllers << 'MetaRoadmapEntriesController'
        controllers << 'MetaRoadmapsController'
      end
