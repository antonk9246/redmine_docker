...
function createGroups() {
  ...
  $('div.journal .notes > .wiki >*:not(.contextual) a:not([target="_blank"]').each(function() {
    var link = $(this);
    var relgroup = 'attachments-' + link.closest('div.wiki').attr('id');
    var title = link.attr('title');
    var href = this.href;

    if(href.match(extensionRegexAll)) {
      link.attr('rel', relgroup)
          .attr('data-fancybox', relgroup)
          .attr('data-caption', title);
    } else{
  ...
  $('.edit-ticket-body .attachments-box .thumbnails a.lightbox').each(function() {
    var relgroup = 'attachments';
    var title = $(this).attr('title');
    $(this)
      .attr('rel', relgroup)
      .attr('data-fancybox', relgroup)
  ...
  $('.quick-edit-form .thumbnails .attachment-box a.lightbox').each(function() {
    var relgroup = 'quick-edit-form';
    var title = $(this).attr('title');
    $(this)
      .attr('rel', relgroup)
      .attr('data-fancybox', relgroup)
  ...
  $('div.attachments a.lightbox')
    ...
    .add('div.journal div.notes > .wiki > *:not(.contextual) a:not([target="_blank"])')
    .add('.edit-ticket-body .attachments-box .thumbnails a.lightbox')
    .add('.quick-edit-form .thumbnails .attachment-box a.lightbox')
    ...
    .fancybox({
      ...
      afterClose: function(){
        setTimeout(function() {
          $(':focus').blur();
          $('body div.ui-tooltip.ui-widget.ui-widget-content').hide();
        }, 1);
      }
    });
