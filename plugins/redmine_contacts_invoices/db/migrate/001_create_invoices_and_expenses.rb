...
class CreateInvoicesAndExpenses < Rails.version < '5.1' ? ActiveRecord::Migration : ActiveRecord::Migration[4.2]
  def self.up
    create_table :invoices do |t|
      t.string :number
      t.datetime :invoice_date
      t.decimal :discount, :precision => 20, :scale => 2, :default => 0, :null => false
