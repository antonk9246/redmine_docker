...
module ExpensesHelper
  ...
  def expenses_to_csv(expenses)
    ...
    export = FCSV.generate(:col_sep => l(:general_csv_separator)) do |csv|
      ...
      expenses.each do |expense|
        ...
        expense.custom_field_values.each {|custom_value| fields << RedmineContacts::Utils::CSVUtils.csv_custom_value(custom_value) }
  ...
  def link_to_expense(expense)
    link_to expense.to_s, expense_path(expense),
