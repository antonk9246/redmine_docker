...
module InvoicesHelper
  ...
  def invoice_to_pdf(invoice)
    if invoice.custom_template || @invoice_template
      ...
      RedmineInvoices::Reports::InvoiceReports.invoice_to_pdf_prawn(invoice, InvoicesSettings.template(@project))
    else
      RedmineInvoices::Reports::InvoiceReports.invoice_to_pdf_prawn(invoice, RedmineInvoices::TEMPLATE_CLASSIC)
    end
  ...
  def invoice_to_pdf_wicked_pdf(invoice, template = nil)
    ...
    content = render_to_string(plain: liquidize_invoice(invoice, template), layout: 'invoices.pdf')
  ...
  def invoices_to_csv(invoices)
    ...
    export = FCSV.generate(:col_sep => l(:general_csv_separator)) do |csv|
      ...
      invoices.each do |invoice|
        ...
        invoice.custom_field_values.each {|custom_value| fields << RedmineContacts::Utils::CSVUtils.csv_custom_value(custom_value) }
