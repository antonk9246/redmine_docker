...
unless Redmine::Notifiable.included_modules.include?(RedmineInvoices::Patches::NotifiablePatch)
  Redmine::Notifiable.send(:include, RedmineInvoices::Patches::NotifiablePatch)
end
