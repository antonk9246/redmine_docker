...
class Contact < ActiveRecord::Base
  ...
  if ActiveRecord::VERSION::MAJOR >= 4
    ...
    has_and_belongs_to_many :related_deals, lambda { order("#{Deal.table_name}.status_id") }, :class_name => 'Deal'
    ...
    has_and_belongs_to_many :related_deals, :order => "#{Deal.table_name}.status_id", :class_name => 'Deal'
    has_and_belongs_to_many :projects
  end
