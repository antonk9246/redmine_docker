...
class DealNote < Note
  ...
  if ActiveRecord::VERSION::MAJOR >= 4
    ...
    { find_options: { joins: [:deal => :project], conditions: { source_type: 'Deal' } } }
  end
  acts_as_activity_provider({ type: 'deals', permission: :view_deals, author_key: :author_id }.merge(join_options))
