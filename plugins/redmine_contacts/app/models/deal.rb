...
class Deal < ActiveRecord::Base
  ...
  if RedmineContacts.products_plugin_installed?
    ...
    rcrm_acts_as_priceable :amount, :tax_amount, :subtotal, :total
  ...
  rcrm_acts_as_priceable :price, :expected_revenue
  ...
  def send_notification
    ContactsMailer.crm_deal_add(User.current, self).deliver if Setting.notified_events.include?('crm_deal_added')
  end
