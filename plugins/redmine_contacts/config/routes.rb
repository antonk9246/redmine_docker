...
#custom routes for this plugin
  ...
  resources :deals do
    ...
    member do
      put :add_product, defaults: { format: :json }
    end
  end
  ...
  match 'deals_issues/:action' => 'deals_issues', :via => [:get, :post, :delete, :put]
  ...
  match 'issues/add_deal_to_issue', :controller => 'issues', :action => 'add_deal_to_issue', :via => :post
