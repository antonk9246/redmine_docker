require 'write_xlsx'
require_relative '../../../../app/helpers/timelog_helper'
...
module RedmineXlsxFormatIssueExporter
  module XlsxReportHelper
    ...
    def report_to_xlsx(report)
      ...
      # Content
      row_index = report_criteria_to_xlsx(workbook, worksheet, row_index = 0, start_period_index, columns_width,report.available_criteria, report.columns, report.criteria, report.periods, report.hours)
      # Total row
    ...
    def report_criteria_to_xlsx(workbook, worksheet, row_index, start_period_index, columns_width, available_criteria, columns, criteria, periods, hours, level=0)
      hours.collect {|h| h[criteria[level]].to_s}.uniq.each do |value|
        ...
        row = [''] * level
        row << format_criteria_value(available_criteria[criteria[level]], value)
