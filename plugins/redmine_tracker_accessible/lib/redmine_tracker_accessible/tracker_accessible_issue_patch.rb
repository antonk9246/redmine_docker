  ...
  def self.included(base)
    base.class_eval do
      ...
      class << self
        ...
        alias_method :visible_condition_block_without_tracker_accessible, :visible_condition_block
        alias_method :visible_condition_block, :visible_condition_block_with_tracker_accessible
      end
      ...
      if ActiveRecord::Base.connection.table_exists?(:issues)
        ...
        alias_method :visible_block_without_tracker_accessible, :visible_block
        alias_method :visible_block, :visible_block_with_tracker_accessible
        # ========= end patch visible =========
        ...
        def notified_users_with_tracker_accessible
          ...
          notified = extra_access_users.select { |u| u.active? && u.mail_notification == 'only_my_events' }
          core_notified = notified_users_without_tracker_accessible
          (core_notified + notified).uniq
        end
        # alias_method_chain :notified_users, :tracker_accessible
        alias_method :notified_users_without_tracker_accessible, :notified_users
        alias_method :notified_users, :notified_users_with_tracker_accessible
